    ...
    async (request) => {
      ...
      return {
        data: result.data.map((activity) => ({
          ...
          initiatorType: activity.initiatorType,
  ...
  app.withTypeProvider<ZodTypeProvider>().post(
    ...
    async (request, reply) => {
      ...
      await auditService.log({
        ...
        metadata: { name: activity.name, targetType, targetId },
      });
  ...
  app.withTypeProvider<ZodTypeProvider>().post(
    ...
    async (request) => {
      ...
      return {
        ...
        initiatorType: updatedActivity!.initiatorType,
        initiatorUserId: updatedActivity!.initiatorUserId,
        targetType: updatedActivity!.targetType,
        ...
        requiresApproval: updatedActivity!.requiresApproval,
        approvalStatus: updatedActivity!.approvalStatus,
